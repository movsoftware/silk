...
#
#
# RCSIDENT("$SiLK: flowcap-ipfix-udp.pl 8d30ceaa3c1f 2019-12-02 15:37:29Z mthomas $")
...
# Generate the test data; do not use the --single-template switch
# since it creates IPFIX Sets that too large for a single UDP packet
