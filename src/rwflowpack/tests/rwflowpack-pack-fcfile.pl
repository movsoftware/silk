...
#
#
# RCSIDENT("$SiLK: rwflowpack-pack-fcfile.pl 40a363507ed0 2014-04-01 14:09:52Z mthomas $")
...
# Create a file and write the flowcap file header to it.
my ($fh, $fcfile) = File::Temp::tempfile("$tmpdir/20090807065432_P0.XXXXXX");
binmode $fh;
print $fh
...
close $fh
    or die "Cannot close $fcfile: $!\n";
check_md5_output('d41d8cd98f00b204e9800998ecf8427e',
                 "$rwappend $fcfile $file{data}");
